      ...
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item" style="background-image: url(https://th-i.thgim.com/public/incoming/z10gvf/article67272757.ece/alternates/LANDSCAPE_1200/15EPBS_LEAD.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated fanimate__adeInDown">Smart <span>Ambulance</span> Dispatch</h2>
                <p class="animate__animated animate__fadeInUp">Our system ensures that ambulances are dispatched intelligently and reach patients in the shortest possible time. With real-time GPS tracking and automated allocation, every emergency call is handled with precision. Hospitals and drivers stay connected seamlessly, reducing delays and saving lives when every second matters.</p>
                <a href="emergencybooking/step1" class="btn-get-started animate__animated animate__fadeInUp">Emergency Booking</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(https://i.pinimg.com/originals/f7/d8/d1/f7d8d12e20b35e984bd385f62023fa0e.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">24/7 <span>Emergency Support</span></h2>
                <p class="animate__animated animate__fadeInUp">Emergencies don’t wait, and neither do we. The Ambulance Management System provides round-the-clock support, ensuring that critical cases are never left unattended. Instant alerts notify medical staff and drivers, creating a reliable chain of response designed to protect and preserve life at any hour of the day.</p>
                <a href="emergencybooking/step1" class="btn-get-started animate__animated animate__fadeInUp">Emergency Booking</a>
              </div>
            </div>
          </div>
